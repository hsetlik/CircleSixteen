...
# 35 "/Users/hayden/Desktop/Electronics/Code/CircleSixteen/CircleSixteen.ino"
...
void checkEncA()
{
    ...
    if (aPos != newPos)
    {
        ...
        int newTrack = (seq.currentTrack + difference) % 4;
        seq.currentTrack = (newTrack < 0) ? 4 + newTrack : newTrack;
        aPos = newPos;
    }
}
